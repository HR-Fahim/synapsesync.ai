      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between bg-white">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-medium text-slate-800">Select a file</h3>
          </div>
        ...
        {/* File List */}
        <div className="flex-1 overflow-y-auto p-2 bg-white min-h-[300px]">
            ...
            {filteredFiles.map(file => (
              <div 
                ...
                className={`flex items-center justify-between p-3 rounded-lg cursor-pointer transition-colors ${
                  selectedId === file.id ? 'bg-blue-50 border border-blue-200' : 'hover:bg-slate-50 border border-transparent'
                }`}
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className={`text-sm font-medium ${selectedId === file.id ? 'text-blue-700' : 'text-slate-800'}`}>
                      {file.name}
                    </h4>
        ...
        <div className="px-6 py-4 border-t border-slate-200 bg-slate-50 flex items-center justify-between">
           <div className="flex items-center gap-2">
             <input type="checkbox" id="autosync" defaultChecked className="rounded text-blue-600 focus:ring-blue-500" />
             <label htmlFor="autosync" className="text-sm text-slate-600">Enable auto-sync & history</label>
           </div>
